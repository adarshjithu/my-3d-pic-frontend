                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {products.map((product: any) => (
                        <div
                            ...
                            key={product?._id}
                            className="bg-white  overflow-hidden cursor-pointer hover:bg-[#e7f5fe] p-2 group"
                        >
                            ...
                            <div className="p-4">
                              ...
                              <StarRating rating={4.9} reviews={4130} />
                                <div className="bg-[#FCE8ED] inline-block px-1 py-1">
                                    <span className="text-[#F85454] text-[10px] sm:text-[14px] font-bold">UPTO 50% OFF</span>
                                </div>
