...
const CommonDeleteModal = ({loading,handleSuccess,item}:any) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-20">
      <div className="bg-white w-full max-w-sm rounded-lg shadow-lg p-6 space-y-4">
        <h3 className="text-xl font-semibold text-gray-800 text-center">Delete {item}</h3>
        <p className="text-center text-gray-600">Are you sure you want to delete this {item}? This action cannot be undone.</p>
