...
function BaseTableHeader() {
    ...
    return (
        <caption className="p-5 text-lg font-semibold text-right rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
            {addBaseModal&&<AddBaseModal setAddBaseModal={setAddBaseModal}/>}
            <div className="flex flex-col sm:flex-row justify-between items-center">
                ...
                {/* New Category Button */}
                <button onClick={()=>setAddBaseModal(true)} className="mt-3 sm:mt-0 text-white bg-blue-500 border hover:bg-blue-600 focus:outline-none font-medium rounded-lg text-sm px-4 py-1 dark:bg-green-600 dark:border-green-500 dark:hover:bg-green-700 dark:focus:ring-green-800">
                    Add New +
                </button>
            </div>
        </caption>
